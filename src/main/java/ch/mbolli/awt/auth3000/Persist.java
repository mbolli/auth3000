...
public class Persist {
    ...
    public Users getUsers() {
        try {
            Users users = (Users) toObject(new File("/home/mbolli/java/Auth3000/src/main/webapp/resources/users.xml"));
            return users;
        } catch (Exception e) {
            e.printStackTrace();
            return new Users();
    ...
    public void setUsers(Users users) {
        try {
            toXMLFile(users, "/home/mbolli/java/Auth3000/src/main/webapp/resources/users.xml");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public Accounts getAccounts() {
        try {
            Accounts accounts = (Accounts) toObject(new File("/home/mbolli/java/Auth3000/src/main/webapp/resources/accounts.xml"));
            return accounts;
        } catch(Exception e) {
            e.printStackTrace();
            return new Accounts();
